 ...
 *
 * A página de medições da obra é um componente de cliente (usa `useParams`), e componente
...
export function generateStaticParams(): { obraId: string }[] {
  return MUNDO.obras.map((o) => ({ obraId: o.id }));
}

export default function LayoutDaMedicao({ children }: { children: React.ReactNode }) {
  return children;
}
